  ...
  return (
    <Card noPadding={true}>
      <div className="px-4 py-2 flex justify-between md:block shadow-md shadow-gray-500 md:shadow-none">
        ...
        {/** 
         * problem started after changing the logout link below into a button, it doesn't work.
         * changing it back to a link works fine, user session is stored in the DB but user information doesn't reflect on the user profiles table.
        */}
